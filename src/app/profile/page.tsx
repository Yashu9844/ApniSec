                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="input-cyber"
                        style={{ paddingLeft: formData.password ? '20px' : '48px' }}
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="input-cyber"
                        style={{ paddingLeft: formData.confirmPassword ? '20px' : '48px' }}
                        placeholder={formData.confirmPassword ? '' : 'Confirm new password'}
                      />
                    </div>
                  </div>
                </div>
